...
Semantic HTML gives meaning to the browser and developer.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Inline only takes up as much room as needed. Block takes up an entire row.
...
Allows for multiple people to work on the same project. As well as Verison control.
